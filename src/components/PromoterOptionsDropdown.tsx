...
export const PromoterOptionsDropdown = ({ promoterId }: Props) => {
  ...
  return (
    <>
          ...
          <Menu.Items className="absolute z-10 -ml-52 w-56 divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:-ml-52">
            <div className="py-1">
              <Menu.Item>
                {({ active }) => (
                  <button
                    onClick={() => router.push(`/promoters/${promoterId}/update`)}
      ...
      <DeletePromoterModal promoterId={promoterId} open={openDeleteModal} setOpen={setOpenDeleteModal} />
    </>
  );
};
